...
This is MyReads Project for the final assessment project for Udacity's React Fundamentals course. 
In this application, we have a list of "shelves" (i.e. categories), each of which contains a number of books.
...
There is also a search page (/search) where you can find other books to add in my library.
...
└── src
    ...
    ├── ListBooks.js # List of books component
    ├── Menu.js # Menu of book component
